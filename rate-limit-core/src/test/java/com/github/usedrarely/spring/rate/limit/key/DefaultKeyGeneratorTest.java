...
package com.github.usedrarely.spring.rate.limit.key;
...
public class DefaultKeyGeneratorTest {
  ...
  public void shouldGenerateDefault() throws NoSuchMethodException {
    ...
    assertThat(keyGenerator.key("", "", joinPoint)).isEqualTo("com.github.usedrarely.spring.rate.limit.key.DefaultKeyGeneratorTest.shouldGenerateDefault");
  }
  ...
  public void shouldGenerateToKey() throws NoSuchMethodException {
    ...
    assertThat(keyGenerator.key("", "#type", joinPoint)).isEqualTo("com.github.usedrarely.spring.rate.limit.key.DefaultKeyGeneratorTest");
  }
