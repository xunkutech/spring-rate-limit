...
/**
 * Common interface used to describe {@link com.github.fzilic.spring.rate.limiting.RateLimited} behaviour.
 * <p/>
...
public interface Options {
   ...
   * Not used with {@link com.github.fzilic.spring.rate.limiting.RateLimited.Configuration#ANNOTATION}.
   * Can be used when using {@link com.github.fzilic.spring.rate.limiting.RateLimited.Configuration#DATABASE} to bloack all requests without code redeploy.
   *
   ...
   * Not used with {@link com.github.fzilic.spring.rate.limiting.RateLimited.Configuration#ANNOTATION}.
   * Can be used when using {@link com.github.fzilic.spring.rate.limiting.RateLimited.Configuration#DATABASE} to disable rate limiting without code redeploy.
   *
